...
- name the post like: **µOS++ posix-io v2.0.1 released**
...
- `npm dist-tag add @micro-os-plus/posix-io@2.0.1 latest`
- `npm dist-tag ls @@micro-os-plus/posix-io`
...
- paste the release name like **µOS++ posix-io v2.0.1 released**
