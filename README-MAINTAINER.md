...
- name the post like: **µOS++ posix-io v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/posix-io@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/posix-io`
...
- paste the release name like **µOS++ posix-io v1.1.0 released**
